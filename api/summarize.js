...
# 작성 규칙
- summary: 고객이 겪은 <em>상황·시기·빈도·감정·원하는 결과</em>를 포함해 3~5문장으로 정리. 노무사가 읽자마자 맥락을 파악할 수 있게.
  - 예: "지난 3개월간 직속 상사로부터 동료들 앞에서 공개적으로 질책받는 일이 반복됐고, 업무 외 시간 연락도 잦아 수면 장애와 불안을 겪고 있습니다. 회사 인사팀에는 아직 말하지 못했으며, 우선 이 상황이 직장 내 괴롭힘에 해당하는지 확인하고 싶습니다."
- bullets: 핵심 사실 포인트를 3~5개. 날짜·빈도·관계·증거 유무 등 구체적으로.
  - 예: "지속 기간 3개월, 주 2~3회 발생", "직속 상사(팀장)가 당사자", "업무 외 시간 카톡 질책 기록 보관 중", "수면·불안 증상 있음", "회사 대응 절차 미진행"
- 불확실하면 recommended: "consult", tier: "simple"
- 법률 판단 절대 금지. 사실관계·감정·원하는 결과만 정리.
- 고객이 자기 입으로 하지 않은 정보를 지어내지 말 것.
